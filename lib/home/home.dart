                    ...
                    child: Row(
                      ...
                      children:[
                        Container(
                          ...
                          padding: const EdgeInsets.only(left: 25, right: 29, top: 11, bottom: 21, ),
                          child: Column(
                            mainAxisSize: MainAxisSize.min,
                            mainAxisAlignment: MainAxisAlignment.end,
                            crossAxisAlignment: CrossAxisAlignment.center,
                    ...
                    child: Row(
                      ...
                      children:[
                        Container(
                          ...
                          padding: const EdgeInsets.only(left: 26, right: 23, top: 5, bottom: 26, ),
                          child: Column(
                            mainAxisSize: MainAxisSize.min,
                            mainAxisAlignment: MainAxisAlignment.end,
                            crossAxisAlignment: CrossAxisAlignment.center,
                    ...
                    child: Row(
                      ...
                      children:[
                        Container(
                          ...
                          padding: const EdgeInsets.only(left: 24, right: 30, top: 11, bottom: 21, ),
                          child: Column(
                            mainAxisSize: MainAxisSize.min,
                            mainAxisAlignment: MainAxisAlignment.end,
                            crossAxisAlignment: CrossAxisAlignment.center,
                    ...
                    child: Row(
                      ...
                      children:[
                        Container(
                          ...
                          padding: const EdgeInsets.only(left: 13, right: 11, top: 13, bottom: 21, ),
                          child: Column(
                            mainAxisSize: MainAxisSize.min,
                            mainAxisAlignment: MainAxisAlignment.end,
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children:[
                              Container(
                                width: 96,
                                height: 96,
                                child: Image.asset('assets/dayOff.png'),
                              ),
                              SizedBox(
                                width: 126,
                                child: Text(
